...
import 'package:quical/presentation/home_page/components/send_money/components/crypto/crypto_page.dart';
import 'package:quical/presentation/home_page/components/send_money/components/fiat/fiat_page.dart';
...
class SendMoneyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final pageControllerProvider = Provider.of<SendMoneyProvider>(context);
