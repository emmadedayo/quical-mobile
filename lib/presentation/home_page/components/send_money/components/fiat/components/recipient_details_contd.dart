...
class RecipientDetailsContd extends StatefulWidget {
  const RecipientDetailsContd({super.key});

  @override
  State<RecipientDetailsContd> createState() => _RecipientDetailsContdState();
}

class _RecipientDetailsContdState extends State<RecipientDetailsContd> {
  bool status = false;
