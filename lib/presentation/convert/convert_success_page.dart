...
class ConvertSuccessPage extends StatelessWidget {
  const ConvertSuccessPage({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                "You have successfully converted 450 NGN, to 0.145 GBP.",
                style: HelperStyle.textStyle(
                  context,
              ...
              // SvgPicture.asset(
              //   AppImage.completeImage,
              //   fit: BoxFit.fitWidth,
              //   width: double.infinity,
              //   color: PsColors.verifyActiveProgressColor,
              ...
              ButtonWidget(
                ...
                onTap: () async {
                  ...
                  //       .pushNamed(RoutePaths.createAccountType);
                },
