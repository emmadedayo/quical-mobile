...
class FaceIDActivated extends StatelessWidget {
  const FaceIDActivated({super.key});
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                "Congratulations. Your face ID has been activated. Continue by Sending money to your friend and family.",
                style: HelperStyle.textStyle(
                  context,
