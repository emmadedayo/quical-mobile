        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                "Before you continue, please verify your email by clicking the link we sent to aremu@quical.com",
                style: HelperStyle.textStyle(
                  context,
              ...
              ButtonWidget(
                containerHeight: 52,
                containerWidth: 370,
                buttonText: "Send the email again",
                buttonTextSize: 18,
                onTap: () async {
                  Navigator.of(context)
                      .pushNamed(RoutePaths.confirmEmailScreen);
                },
